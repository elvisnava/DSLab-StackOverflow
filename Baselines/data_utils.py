...
class Time_Binned_Features:
    ...
    def __init__(self, db_access, gen_features_func, start_time, end_time, n_bins, time_intervals_open_left=True, verbose=0):
        """

        :param db_access: instance of class Data
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, datetime):
            ...
            raise ValueError("The index should be a datetime object or a string that can be formated to a datetime with .data_utils.make_datetime")
